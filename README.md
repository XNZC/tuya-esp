...
## Prerequisites
  + Libraries `lubus`, `lubox`, `lblobmsg_json`, `luci` and [tuya-iot-core-sdk](https://github.com/tuya/tuya-iot-core-sdk) built as a shared library ([patch](https://github.com/XNZC/tuya-sdk-patch))
